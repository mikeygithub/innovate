    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('innovate:match:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.matchInfoEntity.matchId)">修改</el-button>
          <el-button v-if="isAuth('innovate:match:list')" type="text" size="small" @click="retreatHandle(scope.row.matchInfoEntity.matchId)">不通过意见</el-button></template>
      </el-table-column>
    </el-table>
    <el-pagination
